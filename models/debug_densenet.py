...
#     """
#     print('------ densenet161 loading...')
#     model = DenseNet(num_init_features=96, growth_rate=48, block_config=(6, 12, 36, 24),
#                      **kwargs)
    
#     print('+++++++ densenet161 loaded succeeded!!!')
#     if pretrained:
...
def densenet161(pretrained=False, **kwargs):
    ...
    if pretrained:
        ...
        state_dict = model_zoo.load_url(model_urls['densenet161'], 'pretrained_model/encoder')
...
original_model = densenet161(pretrained=True)