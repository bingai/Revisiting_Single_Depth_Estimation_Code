...
def getTrainingData(batch_size=64):
    ...
    transformed_training = depthDataset(csv_file='./datasets/KITTI_raw/KITTI_train.csv',
...
def getTestingData(batch_size=64):
    ...
    transformed_testing = depthDataset(csv_file='./datasets/KITTI_raw/KITTI_test.csv',
                                       transform=transforms.Compose([
                                           Scale(240),
